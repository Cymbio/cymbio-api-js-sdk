...
/**
* The GetVariantResponse model module.
* @module model/GetVariantResponse
* @version 3.0.0
*/
export default class GetVariantResponse {
    /**
    * Constructs a new <code>GetVariantResponse</code>.
    * @alias module:model/GetVariantResponse
    * @class
    * @param id {Number} 
    */
    ...
    /**
    * Constructs a <code>GetVariantResponse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/GetVariantResponse} obj Optional instance to populate.
    * @return {module:model/GetVariantResponse} The populated <code>GetVariantResponse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVariantResponse();
